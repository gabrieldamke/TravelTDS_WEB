...
const ArrayCardsHorizontais: React.FC<ArrayCardsHorizontaisProps> = ({ items, titulo, subtitulo, tamanho }) => {
    return (
      <div>
        {titulo && <h1 className="text-2xl font-bold mb-1">{titulo}</h1>}
        {subtitulo && <h2 className="text-lg font-regular mb-2">{subtitulo}</h2>}
